 ...
 * by replacing __SNORLEX_ALLOWED_PATHS__ with an array of strings with the paths.
 *
...
try {
  ...
  contents = contents.replace('__SNORLEX_ALLOWED_PATHS__', JSON.stringify(paths))
