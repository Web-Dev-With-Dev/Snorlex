 ...
 * For major feature implementations make sure you are able to maintain your code in the future in regard to bugs and possible code conflicts in future updates. Optionally you could join the [Matrix](https://matrix.to/#/#snorlex:matrix.org) channel, so you will hear instantly if something needs to be worked on. 
...
* Make sure your pull request is set up to merge your branch to Snorlex's development branch.
...
* Please make sure your code does not violate any standards set by our linter.  It's up to you to make fixes whenever necessary.  You can run `pnpm run lint` to check locally and `pnpm run lint-fix` to automatically fix smaller issues.
...
* Please try to stay involved with the community and maintain your code.  We are only a handful of developers working on Snorlex in our spare time.  We do not have time to work on everything, and it would be nice if you can maintain your code when necessary.

# Setting up Your Environment

Check out the [wiki](https://docs.snorlexapp.io/development/getting-started/) page to learn how to set up your environment and get started.
