...
class Settings {
  static async find() {
    ...
    // In Snorlex 0.21.3 and earlier the locales 'en-GB', 'es-AR' and 'nb-NO' had underscores instead of a hyphens
    ...
    // In Snorlex 0.22.0 and earlier the external player arguments were displayed in a text box,
    ...
    // In Snorlex 0.23.0, the "Enable Theatre Mode by Default" setting was incoporated as an option
    ...
    // In Snorlex 0.24.0, the "Screenshot Mode" setting only had two options that were represented as a toggle named "Ask path"
