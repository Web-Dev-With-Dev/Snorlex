...
/*
  Mapping of Shaka localization keys for control labels to Snorlex shortcuts.
...
export default defineComponent({
  ...
  setup: function (props, { emit, expose }) {
    ...
    function getPlayerConfig(format, useAutoQuality = false) {
      return {
        // YouTube uses these values and they seem to work well in Snorlex too,
      ...
      if (firstTime) {
        ...
        const firstTimeConfig = {
          ...
          seekBarColors: {
            ...
            // the issue is clearly on the Snorlex side as shaka-player's demo page works fine and they show up all the time for the legacy formats.
            // As I have spent way too much time debugging it and still cannot make sense of it, we'll stick with Snorlex's own chapter markers for now.
    ...
    async function setLocale(locale) {
      // For most of Snorlex's locales, there is an equivalent one in shaka-player,
