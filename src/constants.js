...
/*
  DEV NOTE: Duplicate any and all changes made here to our [official documentation site here](https://github.com/SnorlexApp/Snorlex-Docs/blob/master/usage/keyboard-shortcuts.md)
  to have them reflect on the [keyboard shortcut reference webpage](https://docs.snorlexapp.io/usage/keyboard-shortcuts).
...
/**
 * Material Design Symbols used by Snorlex's custom player components
 *
...
const ABOUT_BITCOIN_ADDRESS = 'bc1qhtnxvn9lswh87f8sw4d4kzurcn9r773p7rrkey'
